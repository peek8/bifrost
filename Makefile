...
# peek8.io/bifrost-bundle:$VERSION and peek8.io/bifrost-catalog:$VERSION.
IMAGE_TAG_BASE ?= peek8.io/bifrost
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name bifrost-builder
	$(CONTAINER_TOOL) buildx use bifrost-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm bifrost-builder
	rm Dockerfile.cross
